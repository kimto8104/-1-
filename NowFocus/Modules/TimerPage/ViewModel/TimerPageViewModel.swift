...
class TimerPageViewModel: ObservableObject {
    ...
    @Published var isFaceDownDisabled: Bool = false
...
extension TimerPageViewModel {
    func startMonitoringDeviceMotion() {
        motionManagerService = MotionManagerService()
        isFaceDownDisabled = false
        motionManagerService?.startMonitoringDeviceMotion()
    }
    ...
    func removeMonitoringDeviceMotion() {
        motionManagerService = nil
        isFaceDownDisabled = true
    }
}
