...
extension TimerPageViewModel {
    ...
    func deleteAllDataForDebug() {
        #if DEBUG
        // SwiftDataの全データを削除
        ModelContainerManager.shared.debugDeleteAllData()
        ...
        self.showFailedView = false
        self.continueFocusingMode = false
        self.totalFocusTime = nil
        
        // Habitが消えるため、設定ビューを再表示させる
        self.currentHabitName = ""
        self.isHabitAlreadyExist = false
        #endif
    }
}
